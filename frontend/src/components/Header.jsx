  ...
  return (
    <header className="w-full max-w-7xl flex justify-between items-center py-6 px-4">
      <div className="flex items-center space-x-2">
        ...
        <span className="text-[1.8rem] font-bold font-kairos text-white">Mr.Bike</span>
      </div>
      <nav className="hidden lg:flex items-center space-x-8 text-white text-sm font-gilroy">
      ...
      <div className="flex items-center space-x-4">
        ...
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="w-6 h-6 hover:text-gray-400 text-white transition-colors cursor-pointer"
        >
          <path
            strokeLinecap="round"
        ...
        <button className="px-5 py-2 border font-gilroy border-white text-white rounded-full text-sm hover:bg-white hover:text-black transition-colors">
          Order Now
        </button>
      </div>
    </header>
